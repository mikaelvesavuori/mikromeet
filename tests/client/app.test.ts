...
describe("Client App Integration", () => {
  beforeEach(() => {
    ...
    document.body.innerHTML = `
      <div id="app">
        ...
        <div id="landing-initial"></div>
        <div id="landing-join"></div>
        <div id="landing-advanced"></div>
        <div id="landing-created"></div>
        ...
        <form id="join-form">
          ...
          <input type="number" id="scheduled-duration">
        ...
        <button id="btn-show-join"></button>
        <button id="btn-show-advanced"></button>
        <button id="btn-back-initial"></button>
        <input id="created-link">
        <div id="created-details"></div>
        <button id="btn-copy-created-link"></button>
        <button id="btn-download-ics"></button>
        <button id="btn-join-created"></button>
        ...
        <button id="btn-incoming-video"></button>
        <button id="btn-reactions"></button>
        ...
        <div id="mobile-menu">
          ...
          <button id="btn-mobile-incoming-video"></button>
          <button id="btn-mobile-reactions"></button>
        </div>
        ...
        <button id="btn-send-file"></button>
  ...
  describe("UIManager", () => {
    ...
    it("should show hand raise and reaction overlays on video tiles", async () => {
      const { UIManager } = await import("../../src/app/ui.js");
      const ui = new UIManager();
      ...
      ui.addRemoteVideo(mockPeer);
      ui.updatePeerStatus("test-user", { isHandRaised: true });
      ui.showReaction("test-user", "clap", "Test User");

      const tile = document.getElementById("video-test-user");
      expect(tile?.classList.contains("hand-raised")).toBe(true);
      expect(tile?.querySelector(".tile-hand-badge")?.classList.contains("hidden")).toBe(false);
      expect(tile?.querySelector(".reaction-badge svg use")?.getAttribute("href")).toBe(
        "#icon-reaction-clap",
      );
    });
  });
