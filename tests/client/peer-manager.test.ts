...
import { PeerManager } from "../../src/app/peer-manager.js";
...
describe("PeerManager", () => {
  ...
  describe("createPeerConnection", () => {
    ...
    it("should send ICE candidate when one is generated", async () => {
      ...
      const onIceCandidate = connection.onicecandidate as
  ...
  describe("handleAnswer", () => {
    ...
    it("should not throw if peer does not exist", async () => {
      await expect(peerManager.handleAnswer("non-existent", "answer-sdp")).resolves.not.toThrow();
    });
  });
